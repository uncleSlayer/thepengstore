...
const IndProduct = () => {
    ...
    return (
        <>
            ...
            }} className="fixed bottom-24 font-sans font-bold mx-auto left-0 right-0 w-32 border-2 bg-blackbg text-white rounded-lg shadow-lg px-2 py-1">Add to cart</button>
            <BottomNav />
        </>
    )
}
